...
Item {
    ...
    property int hintSize: units.gu(10)
    property color hintColor: "#8b0000"
    property string hintIconName: "wikipedia-symbolic"
    ...
    property real expandedPosition: (0.85 - 0.35 * expandAngle/360) * height
    property real collapsedPosition: height - hintSize/2

    property list<RadialAction> actions
    property real actionButtonSize: units.gu(8)
    property real actionButtonDistance: 1.3* hintSize
